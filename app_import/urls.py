...
urlpatterns = [
    ...
    path('invoice_mes', views.invoice_mes, name='invoice_mes'),
    path('export_all_excel', views.export_all_excel, name='export_all_excel'),
    path('show_tyres_balance', views.show_tyres_balance, name='show_tyres_balance'),
    path('show_report_excel', views.show_report_excel, name='show_report_excel'),
    ]
